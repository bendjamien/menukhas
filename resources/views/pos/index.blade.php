        ...
        <div class="flex flex-col md:flex-row flex-grow overflow-hidden">
                        ...
                        @forelse ($produks as $produk)
                            ...
                            <div x-data="{ qty: 1, currentStock: {{ $displayStock }} }" 
                                ...
                                <div class="bg-white rounded-2xl border border-gray-200 hover:border-sky-400 hover:shadow-lg transition-all duration-300 flex flex-col h-full overflow-hidden shadow-sm group relative">
                                    ...
                                    <!-- Content Area (FIXED: Row spacing and padding) -->
            ...
            <div class="w-full md:w-[360px] flex flex-col bg-white shrink-0 border-l border-gray-100">
                ...
                <div class="p-6 bg-white border-t border-gray-100">
                    ...
                    <div class="space-y-3">
                        <a href="{{ route('pos.checkout.show', $activeDraft) }}" class="w-full bg-sky-600 hover:bg-sky-700 text-white font-black py-4 rounded-2xl shadow-xl shadow-sky-500/20 transition-all flex items-center justify-center gap-3 active:scale-95 {{ $activeDraft->details->isEmpty() ? 'opacity-50 pointer-events-none grayscale' : '' }}"><span class="text-lg uppercase tracking-wider">BAYAR SEKARANG</span><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg></a>
