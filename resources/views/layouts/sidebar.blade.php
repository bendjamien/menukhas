    ...
    <nav class="flex-grow mt-4 overflow-y-auto">
        <ul class="flex flex-col space-y-2">
            ...
            <li x-data="{ 
                ...
                <ul x-show="open" x-transition class="ml-6 space-y-2">
                    <li>
                    ...
                    @if(Auth::user()->role == 'admin')
                        <li>
                            <a href="{{ route('kategori.index') }}" class="block px-4 py-2 rounded-lg text-sm {{ request()->is('kategori*') ? 'bg-gray-200 text-gray-800' : 'text-gray-600 hover:bg-gray-100' }}">
                                Data Kategori
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('produk.index') }}" class="block px-4 py-2 rounded-lg text-sm {{ request()->is('produk*') ? 'bg-gray-200 text-gray-800' : 'text-gray-600 hover:bg-gray-100' }}">
                                Data Produk
                            </a>
                        </li>
                    @endif
            ...
            <li x-data="{ 
                    open: {{ (request()->is('transaksi*') || request()->is('stok-log*') || request()->is('pembayaran*') || request()->is('laporan*')) ? 'true' : 'false' }} 
                }" class="space-y-2">
                ...
                <button @click="open = !open"
                    ...
                    <span class="absolute right-0 h-full w-2 rounded-r-lg {{ (request()->is('transaksi*') || request()->is('stok-log*') || request()->is('pembayaran*') || request()->is('laporan*')) ? 'bg-sky-600' : '' }}"></span>
            ...
            @if(Auth::user()->role == 'admin')
                <li x-data="{ 
                    ...
                    <ul x-show="open" x-transition class="ml-6 space-y-2">
                        <li>
                            <a href="{{ route('users.index') }}" class="block px-4 py-2 rounded-lg text-sm {{ request()->is('users*') ? 'bg-gray-200 text-gray-800' : 'text-gray-600 hover:bg-gray-100' }}">
                                Manajemen Akun
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('pengaturan.index') }}" class="block px-4 py-2 rounded-lg text-sm {{ request()->is('pengaturan*') ? 'bg-gray-200 text-gray-800' : 'text-gray-600 hover:bg-gray-100' }}">
                                Pengaturan
                            </a>
                        </li>
                    </ul>
