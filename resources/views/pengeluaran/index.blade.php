    ...
    <div class="space-y-8" x-data="{ 
                        ...
                        @forelse ($pengeluarans as $p)
                            <tr class="hover:bg-slate-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <button @click="$dispatch('open-modal', 'confirm-delete-modal'); deleteUrl = '{{ route('pengeluaran.destroy', $p) }}'; itemName = '#EXP-{{ $p->id }}'" 
        ...
        <x-modal name="confirm-delete-modal" focusable maxWidth="sm">
            <div class="p-8 text-center">
                ...
                <h2 class="text-xl font-black text-slate-800 mb-2 uppercase tracking-tight">Hapus Data?</h2>
                <p class="text-slate-500 text-sm mb-8">Anda yakin ingin menghapus <span class="font-bold text-slate-800" x-text="itemName"></span>? Data yang dihapus tidak dapat dikembalikan.</p>
